                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <a href="{{ route('jenis_faskes.index') }}" class="btn btn-success btn-sm"> Kembali</a>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('jenis_faskes.store') }}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" value="{{ $jenis_faskes->nama }}" name="nama" id="nama" class="form-control col-md-8" required>
                                </div>
